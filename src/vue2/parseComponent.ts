...
import type { ASTAttr, SFCBlock, SFCDescriptor, SFCScriptBlock, VueTemplateCompilerParseOptions } from './types'
    ...
    if (depth === 0) {
      ...
      if (isSpecialTag(tag)) {
        ...
        if (tag === 'script') {
          ...
          sfc[tag as 'template'] = currentBlock
        }
      }
      else {
        // custom blocks
